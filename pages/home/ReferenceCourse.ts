...
export default class ReferenceCourse {
  readonly page: Page;
  ...
  constructor(page: Page) {
    this.page = page;
    this.sectionTitle = page.locator(".homePage .mt-5").first().locator("h6 a", {
      hasText: "Khóa học tham khảo",
    });
  }
  ...
  async verifySectionReady() {
    ...
    const firstCardFooter = this.page
      .locator(".homePage .mt-5").first().locator(".cardGlobalRes .cardFooter")
      .first();
  ...
  async verifyCoursesDisplayed() {
    return this.withSectionReady(async () => {
      const courses = this.page.locator(".homePage .mt-5").first().locator(".cardGlobalRes");
  ...
  async verifyCourseTitles() {
    return this.withSectionReady(async () => {
      const titles = this.page.locator(
        ".homePage .mt-5").first().locator(".cardGlobalRes .cardBodyGlobal h6"
      );
  ...
  async verifyCourseCategories() {
    return this.withSectionReady(async () => {
      const categories = this.page.locator(
        ".homePage .mt-5").first().locator(".cardGlobalRes .stikerCard"
      );
  ...
  async verifyCourseHours() {
    return this.withSectionReady(async () => {
      const courseCards = this.page.locator(".homePage .mt-5").first().locator(".cardGlobalRes");
  ...
  async verifyCourseLevels() {
    return this.withSectionReady(async () => {
      const cards = this.page.locator(".homePage .mt-5").first().locator(".cardGlobalRes");
  ...
  async verifyCourseTeachers() {
    return this.withSectionReady(async () => {
      const teacherBlocks = this.page.locator(
        ".homePage .mt-5").first().locator(".cardGlobalRes .titleMaker"
      );
  ...
  async verifyCoursePrices() {
    return this.withSectionReady(async () => {
      const priceBlocks = this.page.locator(
        ".homePage .mt-5").first().locator(".cardGlobalRes .cardFooter div:nth-child(2)"
      );
  ...
  async verifyCourseHoverShowsSubCard() {
    return this.withSectionReady(async () => {
      const courseCards = this.page.locator(
        ".homePage .mt-5").first().locator(".cardGlobalRes .cardGlobal"
      );
      const count = await courseCards.count();
      expect(count).toBeGreaterThan(0);
  ...
  async verifyCourseLinks() {
    return this.withSectionReady(async () => {
      const courseCards = this.page.locator(
        ".homePage .mt-5").first().locator(".cardGlobalRes a.cardGlobal"
      );
      const count = await courseCards.count();
      expect(count).toBeGreaterThan(0);
